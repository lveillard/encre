...
pub const BUILTIN_PLUGINS: &[&'static Plugin] = &[
    ...
    &layout::placement::PLUGIN_1,
    &layout::placement::PLUGIN_2,
    &layout::placement::PLUGIN_X_1,
    &layout::placement::PLUGIN_X_2,
    &layout::placement::PLUGIN_Y_1,
    &layout::placement::PLUGIN_Y_2,
    &layout::placement::PLUGIN_START_1,
    &layout::placement::PLUGIN_START_2,
    &layout::placement::PLUGIN_END_1,
    &layout::placement::PLUGIN_END_2,
    &layout::placement::PLUGIN_TOP_1,
    &layout::placement::PLUGIN_TOP_2,
    &layout::placement::PLUGIN_RIGHT_1,
    &layout::placement::PLUGIN_RIGHT_2,
    &layout::placement::PLUGIN_BOTTOM_1,
    &layout::placement::PLUGIN_BOTTOM_2,
    &layout::placement::PLUGIN_LEFT_1,
    &layout::placement::PLUGIN_LEFT_2,
    ...
    &grid::grid_row::PLUGIN_1,
    &grid::grid_row::PLUGIN_2,
    ...
    &layout::clear::PLUGIN,
    &spacing::margin::PLUGIN_1,
    &spacing::margin::PLUGIN_2,
    &spacing::margin::PLUGIN_X_1,
    &spacing::margin::PLUGIN_X_2,
    &spacing::margin::PLUGIN_Y_1,
    &spacing::margin::PLUGIN_Y_2,
    &spacing::margin::PLUGIN_START_1,
    &spacing::margin::PLUGIN_START_2,
    &spacing::margin::PLUGIN_END_1,
    &spacing::margin::PLUGIN_END_2,
    &spacing::margin::PLUGIN_TOP_1,
    &spacing::margin::PLUGIN_TOP_2,
    &spacing::margin::PLUGIN_RIGHT_1,
    &spacing::margin::PLUGIN_RIGHT_2,
    &spacing::margin::PLUGIN_BOTTOM_1,
    &spacing::margin::PLUGIN_BOTTOM_2,
    &spacing::margin::PLUGIN_LEFT_1,
    &spacing::margin::PLUGIN_LEFT_2,
    &layout::box_sizing::PLUGIN,
    &layout::display::PLUGIN,
    &layout::aspect_ratio::PLUGIN_1,
    &layout::aspect_ratio::PLUGIN_2,
    &sizing::height::PLUGIN_1,
    &sizing::height::PLUGIN_2,
    &sizing::max_height::PLUGIN_1,
    &sizing::max_height::PLUGIN_2,
    &sizing::min_height::PLUGIN_1,
    &sizing::min_height::PLUGIN_2,
    &sizing::width::PLUGIN_1,
    &sizing::width::PLUGIN_2,
    &sizing::min_width::PLUGIN_1,
    &sizing::min_width::PLUGIN_2,
    &sizing::max_width::PLUGIN_1,
    &sizing::max_width::PLUGIN_2,
    &sizing::max_width::PLUGIN_3,
    &flexbox::flex::PLUGIN_1,
    &flexbox::flex::PLUGIN_2,
    &flexbox::flex_shrink::PLUGIN,
    &flexbox::flex_grow::PLUGIN,
    &flexbox::flex_basis::PLUGIN_1,
    &flexbox::flex_basis::PLUGIN_2,
    &table::table_layout::PLUGIN,
    &table::caption_side::PLUGIN,
    &table::border_collapse::PLUGIN,
    &table::border_spacing::PLUGIN_1,
    &table::border_spacing::PLUGIN_2,
    &table::border_spacing::PLUGIN_X_1,
    &table::border_spacing::PLUGIN_X_2,
    &table::border_spacing::PLUGIN_Y_1,
    &table::border_spacing::PLUGIN_Y_2,
    &transform::transform_origin::PLUGIN_1,
    &transform::transform_origin::PLUGIN_2,
    &transform::perspective_origin::PLUGIN_1,
    &transform::perspective_origin::PLUGIN_2,
    &transform::perspective::PLUGIN_1,
    &transform::perspective::PLUGIN_2,
    &transform::translate::PLUGIN_X_1,
    &transform::translate::PLUGIN_X_2,
    &transform::translate::PLUGIN_Y_1,
    &transform::translate::PLUGIN_Y_2,
    &transform::translate::PLUGIN_Z_1,
    &transform::translate::PLUGIN_Z_2,
    &transform::rotate::PLUGIN_1,
    &transform::rotate::PLUGIN_2,
    &transform::rotate::PLUGIN_X_1,
    &transform::rotate::PLUGIN_X_2,
    &transform::rotate::PLUGIN_Y_1,
    &transform::rotate::PLUGIN_Y_2,
    &transform::rotate::PLUGIN_Z_1,
    &transform::rotate::PLUGIN_Z_2,
    &transform::skew::PLUGIN_X_1,
    &transform::skew::PLUGIN_X_2,
    &transform::skew::PLUGIN_Y_1,
    &transform::skew::PLUGIN_Y_2,
    &transform::scale::PLUGIN_1,
    &transform::scale::PLUGIN_2,
    &transform::scale::PLUGIN_X_1,
    &transform::scale::PLUGIN_X_2,
    &transform::scale::PLUGIN_Y_1,
    &transform::scale::PLUGIN_Y_2,
    &transform::scale::PLUGIN_Z_1,
    &transform::scale::PLUGIN_Z_2,
    &transform::transform_type::PLUGIN,
    &transition::animation::PLUGIN_1,
    &transition::animation::PLUGIN_2,
    &interactivity::cursor::PLUGIN_1,
    &interactivity::cursor::PLUGIN_2,
    ...
    &interactivity::scroll_margin::PLUGIN_1,
    &interactivity::scroll_margin::PLUGIN_2,
    &interactivity::scroll_margin::PLUGIN_X_1,
    &interactivity::scroll_margin::PLUGIN_X_2,
    &interactivity::scroll_margin::PLUGIN_Y_1,
    &interactivity::scroll_margin::PLUGIN_Y_2,
    &interactivity::scroll_margin::PLUGIN_START_1,
    &interactivity::scroll_margin::PLUGIN_START_2,
    &interactivity::scroll_margin::PLUGIN_END_1,
    &interactivity::scroll_margin::PLUGIN_END_2,
    &interactivity::scroll_margin::PLUGIN_TOP_1,
    &interactivity::scroll_margin::PLUGIN_TOP_2,
    &interactivity::scroll_margin::PLUGIN_RIGHT_1,
    &interactivity::scroll_margin::PLUGIN_RIGHT_2,
    &interactivity::scroll_margin::PLUGIN_BOTTOM_1,
    &interactivity::scroll_margin::PLUGIN_BOTTOM_2,
    &interactivity::scroll_margin::PLUGIN_LEFT_1,
    &interactivity::scroll_margin::PLUGIN_LEFT_2,
    &interactivity::scroll_padding::PLUGIN_1,
    &interactivity::scroll_padding::PLUGIN_2,
    &interactivity::scroll_padding::PLUGIN_X_1,
    &interactivity::scroll_padding::PLUGIN_X_2,
    &interactivity::scroll_padding::PLUGIN_Y_1,
    &interactivity::scroll_padding::PLUGIN_Y_2,
    &interactivity::scroll_padding::PLUGIN_START_1,
    &interactivity::scroll_padding::PLUGIN_START_2,
    &interactivity::scroll_padding::PLUGIN_END_1,
    &interactivity::scroll_padding::PLUGIN_END_2,
    &interactivity::scroll_padding::PLUGIN_TOP_1,
    &interactivity::scroll_padding::PLUGIN_TOP_2,
    &interactivity::scroll_padding::PLUGIN_RIGHT_1,
    &interactivity::scroll_padding::PLUGIN_RIGHT_2,
    &interactivity::scroll_padding::PLUGIN_BOTTOM_1,
    &interactivity::scroll_padding::PLUGIN_BOTTOM_2,
    &interactivity::scroll_padding::PLUGIN_LEFT_1,
    &interactivity::scroll_padding::PLUGIN_LEFT_2,
    &typography::list_style_position::PLUGIN,
    &typography::list_style_type::PLUGIN_1,
    &typography::list_style_type::PLUGIN_2,
    ...
    &grid::grid_auto_columns::PLUGIN_1,
    &grid::grid_auto_columns::PLUGIN_2,
    &grid::grid_auto_flow::PLUGIN,
    &grid::grid_auto_rows::PLUGIN_1,
    &grid::grid_auto_rows::PLUGIN_2,
    &grid::grid_template_columns::PLUGIN_1,
    &grid::grid_template_columns::PLUGIN_2,
    &grid::grid_template_columns::PLUGIN_3,
    &grid::grid_template_rows::PLUGIN_1,
    &grid::grid_template_rows::PLUGIN_2,
    &grid::grid_template_rows::PLUGIN_3,
    ...
    &border::divide_color::PLUGIN_1,
    &border::divide_color::PLUGIN_2,
    ...
    &border::border_radius::PLUGIN_1,
    &border::border_radius::PLUGIN_2,
    &border::border_radius::PLUGIN_START_1,
    &border::border_radius::PLUGIN_START_2,
    &border::border_radius::PLUGIN_END_1,
    &border::border_radius::PLUGIN_END_2,
    &border::border_radius::PLUGIN_TOP_1,
    &border::border_radius::PLUGIN_TOP_2,
    &border::border_radius::PLUGIN_RIGHT_1,
    &border::border_radius::PLUGIN_RIGHT_2,
    &border::border_radius::PLUGIN_BOTTOM_1,
    &border::border_radius::PLUGIN_BOTTOM_2,
    &border::border_radius::PLUGIN_LEFT_1,
    &border::border_radius::PLUGIN_LEFT_2,
    &border::border_radius::PLUGIN_START_START_1,
    &border::border_radius::PLUGIN_START_START_2,
    &border::border_radius::PLUGIN_START_END_1,
    &border::border_radius::PLUGIN_START_END_2,
    &border::border_radius::PLUGIN_END_END_1,
    &border::border_radius::PLUGIN_END_END_2,
    &border::border_radius::PLUGIN_END_START_1,
    &border::border_radius::PLUGIN_END_START_2,
    &border::border_radius::PLUGIN_TOP_RIGHT_1,
    &border::border_radius::PLUGIN_TOP_RIGHT_2,
    &border::border_radius::PLUGIN_TOP_LEFT_1,
    &border::border_radius::PLUGIN_TOP_LEFT_2,
    &border::border_radius::PLUGIN_BOTTOM_RIGHT_1,
    &border::border_radius::PLUGIN_BOTTOM_RIGHT_2,
    &border::border_radius::PLUGIN_BOTTOM_LEFT_1,
    &border::border_radius::PLUGIN_BOTTOM_LEFT_2,
    &border::border_width::PLUGIN_1,
    &border::border_width::PLUGIN_2,
    &border::border_width::PLUGIN_X_1,
    &border::border_width::PLUGIN_X_2,
    &border::border_width::PLUGIN_Y_1,
    &border::border_width::PLUGIN_Y_2,
    &border::border_width::PLUGIN_START_1,
    &border::border_width::PLUGIN_START_2,
    &border::border_width::PLUGIN_END_1,
    &border::border_width::PLUGIN_END_2,
    &border::border_width::PLUGIN_TOP_1,
    &border::border_width::PLUGIN_TOP_2,
    &border::border_width::PLUGIN_RIGHT_1,
    &border::border_width::PLUGIN_RIGHT_2,
    &border::border_width::PLUGIN_BOTTOM_1,
    &border::border_width::PLUGIN_BOTTOM_2,
    &border::border_width::PLUGIN_LEFT_1,
    &border::border_width::PLUGIN_LEFT_2,
    &border::border_style::PLUGIN_1,
    &border::border_style::PLUGIN_2,
    &border::border_color::PLUGIN_1,
    &border::border_color::PLUGIN_2,
    &border::border_color::PLUGIN_X_1,
    &border::border_color::PLUGIN_X_2,
    &border::border_color::PLUGIN_Y_1,
    &border::border_color::PLUGIN_Y_2,
    &border::border_color::PLUGIN_START_1,
    &border::border_color::PLUGIN_START_2,
    &border::border_color::PLUGIN_END_1,
    &border::border_color::PLUGIN_END_2,
    &border::border_color::PLUGIN_TOP_1,
    &border::border_color::PLUGIN_TOP_2,
    &border::border_color::PLUGIN_RIGHT_1,
    &border::border_color::PLUGIN_RIGHT_2,
    &border::border_color::PLUGIN_BOTTOM_1,
    &border::border_color::PLUGIN_BOTTOM_2,
    &border::border_color::PLUGIN_LEFT_1,
    &border::border_color::PLUGIN_LEFT_2,
    &background::background_color::PLUGIN_1,
    &background::background_color::PLUGIN_2,
    &background::background_image::PLUGIN_1,
    &background::background_image::PLUGIN_2,
    ...
    &background::background_size::PLUGIN_1,
    &background::background_size::PLUGIN_2,
    &background::background_attachment::PLUGIN,
    &background::background_clip::PLUGIN,
    &background::background_position::PLUGIN_1,
    &background::background_position::PLUGIN_2,
    ...
    &svg::stroke::PLUGIN_1,
    &svg::stroke::PLUGIN_2,
    &svg::stroke_width::PLUGIN_1,
    &svg::stroke_width::PLUGIN_2,
    &layout::object_fit::PLUGIN,
    &layout::object_position::PLUGIN_1,
    &layout::object_position::PLUGIN_2,
    &spacing::padding::PLUGIN_1,
    &spacing::padding::PLUGIN_2,
    &spacing::padding::PLUGIN_X_1,
    &spacing::padding::PLUGIN_X_2,
    &spacing::padding::PLUGIN_Y_1,
    &spacing::padding::PLUGIN_Y_2,
    &spacing::padding::PLUGIN_START_1,
    &spacing::padding::PLUGIN_START_2,
    &spacing::padding::PLUGIN_END_1,
    &spacing::padding::PLUGIN_END_2,
    &spacing::padding::PLUGIN_TOP_1,
    &spacing::padding::PLUGIN_TOP_2,
    &spacing::padding::PLUGIN_RIGHT_1,
    &spacing::padding::PLUGIN_RIGHT_2,
    &spacing::padding::PLUGIN_BOTTOM_1,
    &spacing::padding::PLUGIN_BOTTOM_2,
    &spacing::padding::PLUGIN_LEFT_1,
    &spacing::padding::PLUGIN_LEFT_2,
    &typography::text_align::PLUGIN,
    &typography::text_indent::PLUGIN_1,
    &typography::text_indent::PLUGIN_2,
    &typography::vertical_align::PLUGIN,
    &typography::font_family::PLUGIN_1,
    &typography::font_family::PLUGIN_2,
    &typography::font_size::PLUGIN_1,
    &typography::font_size::PLUGIN_2,
    &typography::font_weight::PLUGIN_1,
    &typography::font_weight::PLUGIN_2,
    &typography::text_transform::PLUGIN,
    &typography::font_style::PLUGIN,
    &typography::font_variant_numeric::PLUGIN,
    &typography::letter_spacing::PLUGIN_1,
    &typography::letter_spacing::PLUGIN_2,
    &typography::line_height::PLUGIN_1,
    &typography::line_height::PLUGIN_2,
    &typography::line_height::PLUGIN_3,
    &typography::text_color::PLUGIN_1,
    &typography::text_color::PLUGIN_2,
    &typography::text_decoration::PLUGIN,
    &typography::text_decoration_color::PLUGIN_1,
    &typography::text_decoration_color::PLUGIN_2,
    &typography::text_decoration_style::PLUGIN,
    &typography::text_decoration_thickness::PLUGIN_1,
    &typography::text_decoration_thickness::PLUGIN_2,
    &typography::text_decoration_thickness::PLUGIN_3,
    &typography::text_underline_offset::PLUGIN_1,
    &typography::text_underline_offset::PLUGIN_2,
    &typography::text_underline_offset::PLUGIN_3,
    &typography::font_smoothing::PLUGIN,
    &interactivity::caret_color::PLUGIN_1,
    &interactivity::caret_color::PLUGIN_2,
    &interactivity::accent_color::PLUGIN_1,
    &interactivity::accent_color::PLUGIN_2,
    &effect::opacity::PLUGIN,
    &effect::background_blend_mode::PLUGIN,
    &effect::mix_blend_mode::PLUGIN,
    &effect::text_shadow::PLUGIN_1,
    &effect::text_shadow::PLUGIN_2,
    &effect::text_shadow_color::PLUGIN_1,
    &effect::text_shadow_color::PLUGIN_2,
    &effect::box_shadow::PLUGIN_1,
    &effect::box_shadow::PLUGIN_2,
    &effect::box_shadow_color::PLUGIN_1,
    &effect::box_shadow_color::PLUGIN_2,
    ...
    &border::outline_style::PLUGIN_1,
    &border::outline_style::PLUGIN_2,
    &border::outline_width::PLUGIN_1,
    &border::outline_width::PLUGIN_2,
    &border::outline_offset::PLUGIN_1,
    &border::outline_offset::PLUGIN_2,
    &border::outline_color::PLUGIN_1,
    &border::outline_color::PLUGIN_2,
    &border::ring_width::PLUGIN_1,
    &border::ring_width::PLUGIN_2,
    &border::ring_color::PLUGIN_1,
    &border::ring_color::PLUGIN_2,
    ...
    &border::ring_offset_width::PLUGIN_1,
    &border::ring_offset_width::PLUGIN_2,
    &border::ring_offset_color::PLUGIN_1,
    &border::ring_offset_color::PLUGIN_2,
    &filter::blur::PLUGIN_1,
    &filter::blur::PLUGIN_2,
    &filter::brightness::PLUGIN,
    &filter::contrast::PLUGIN,
    &filter::drop_shadow::PLUGIN_1,
    &filter::drop_shadow::PLUGIN_2,
    &filter::grayscale::PLUGIN,
    &filter::hue_rotate::PLUGIN_1,
    &filter::hue_rotate::PLUGIN_2,
    &filter::invert::PLUGIN,
    &filter::saturate::PLUGIN,
    &filter::sepia::PLUGIN,
    &filter::filter_type::PLUGIN,
    &filter::backdrop_blur::PLUGIN_1,
    &filter::backdrop_blur::PLUGIN_2,
    &filter::backdrop_brightness::PLUGIN,
    &filter::backdrop_contrast::PLUGIN,
    &filter::backdrop_grayscale::PLUGIN,
    &filter::backdrop_hue_rotate::PLUGIN_1,
    &filter::backdrop_hue_rotate::PLUGIN_2,
    &filter::backdrop_invert::PLUGIN,
    &filter::backdrop_saturate::PLUGIN,
    &filter::backdrop_sepia::PLUGIN,
    &filter::backdrop_filter::PLUGIN,
    &transition::transition_property::PLUGIN_1,
    &transition::transition_property::PLUGIN_2,
    &transition::transition_delay::PLUGIN_1,
    &transition::transition_delay::PLUGIN_2,
    &transition::transition_duration::PLUGIN_1,
    &transition::transition_duration::PLUGIN_2,
    &transition::transition_timing_function::PLUGIN_1,
    &transition::transition_timing_function::PLUGIN_2,
    &interactivity::will_change::PLUGIN_1,
    &interactivity::will_change::PLUGIN_2,
    &typography::content::PLUGIN_1,
    &typography::content::PLUGIN_2,
    &typography::line_clamp::PLUGIN_1,
    &typography::line_clamp::PLUGIN_2,
    &layout::at_container::PLUGIN_1,
    &layout::at_container::PLUGIN_2,
];
