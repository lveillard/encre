...
pub const BUILTIN_PLUGINS: &[(Cow<'static, str>, &'static Plugin)] = &[
    ...
    (Cow::Borrowed("animate"), &transition::animation::PLUGIN_1),
    (Cow::Borrowed("animate"), &transition::animation::PLUGIN_2),
    ...
    (Cow::Borrowed("space-x"), &spacing::space_between::PLUGIN_X_1),
    (Cow::Borrowed("space-x"), &spacing::space_between::PLUGIN_X_2),
    (Cow::Borrowed("space-x"), &spacing::space_between::PLUGIN_X_3),
    (Cow::Borrowed("space-y"), &spacing::space_between::PLUGIN_Y_1),
    (Cow::Borrowed("space-y"), &spacing::space_between::PLUGIN_Y_2),
    (Cow::Borrowed("space-y"), &spacing::space_between::PLUGIN_Y_3),
    (Cow::Borrowed("divide-x"), &border::divide_width::PLUGIN_X_1),
    (Cow::Borrowed("divide-x"), &border::divide_width::PLUGIN_X_2),
    (Cow::Borrowed("divide-x"), &border::divide_width::PLUGIN_X_3),
    (Cow::Borrowed("divide-y"), &border::divide_width::PLUGIN_Y_1),
    (Cow::Borrowed("divide-y"), &border::divide_width::PLUGIN_Y_2),
    (Cow::Borrowed("divide-y"), &border::divide_width::PLUGIN_Y_3),
    (Cow::Borrowed("divide"), &border::divide_style::PLUGIN),
    (Cow::Borrowed("divide"), &border::divide_color::PLUGIN_1),
    (Cow::Borrowed("divide"), &border::divide_color::PLUGIN_2),
    ...
    (Cow::Borrowed("bg"), &background::background_image::PLUGIN_1),
    (Cow::Borrowed("bg"), &background::background_image::PLUGIN_2),
    (Cow::Borrowed("bg-linear"), &background::background_image::PLUGIN_LINEAR_1),
    (Cow::Borrowed("bg-linear"), &background::background_image::PLUGIN_LINEAR_2),
    (Cow::Borrowed("bg-linear"), &background::background_image::PLUGIN_LINEAR_3),
    (Cow::Borrowed("bg-radial"), &background::background_image::PLUGIN_RADIAL_1),
    (Cow::Borrowed("bg-radial"), &background::background_image::PLUGIN_RADIAL_2),
    (Cow::Borrowed("bg-conic"), &background::background_image::PLUGIN_CONIC_1),
    (Cow::Borrowed("bg-conic"), &background::background_image::PLUGIN_CONIC_2),
    (Cow::Borrowed("bg-conic"), &background::background_image::PLUGIN_CONIC_3),
    (Cow::Borrowed("from"), &background::gradient_color_stops::PLUGIN_FROM_1),
    (Cow::Borrowed("from"), &background::gradient_color_stops::PLUGIN_FROM_2),
    (Cow::Borrowed("via"), &background::gradient_color_stops::PLUGIN_VIA_1),
    (Cow::Borrowed("via"), &background::gradient_color_stops::PLUGIN_VIA_2),
    (Cow::Borrowed("to"), &background::gradient_color_stops::PLUGIN_TO_1),
    (Cow::Borrowed("to"), &background::gradient_color_stops::PLUGIN_TO_2),
    ...
    (Cow::Borrowed("ring"), &border::ring_width::PLUGIN_1),
    (Cow::Borrowed("ring"), &border::ring_width::PLUGIN_2),
    (Cow::Borrowed("ring"), &border::ring_color::PLUGIN_1),
    (Cow::Borrowed("ring"), &border::ring_color::PLUGIN_2),
    (Cow::Borrowed("inset-ring"), &border::ring_width::PLUGIN_INSET_1),
    (Cow::Borrowed("inset-ring"), &border::ring_width::PLUGIN_INSET_2),
    (Cow::Borrowed("inset-ring"), &border::ring_color::PLUGIN_INSET_1),
    (Cow::Borrowed("inset-ring"), &border::ring_color::PLUGIN_INSET_2),
    (Cow::Borrowed("ring-offset"), &border::ring_offset_width::PLUGIN_1),
    (Cow::Borrowed("ring-offset"), &border::ring_offset_width::PLUGIN_2),
    (Cow::Borrowed("ring-offset"), &border::ring_offset_color::PLUGIN_1),
    (Cow::Borrowed("ring-offset"), &border::ring_offset_color::PLUGIN_2),
    (Cow::Borrowed("blur"), &filter::blur::PLUGIN_1),
    (Cow::Borrowed("blur"), &filter::blur::PLUGIN_2),
    (Cow::Borrowed("brightness"), &filter::brightness::PLUGIN),
    (Cow::Borrowed("contrast"), &filter::contrast::PLUGIN),
    (Cow::Borrowed("drop-shadow"), &filter::drop_shadow::PLUGIN_1),
    (Cow::Borrowed("drop-shadow"), &filter::drop_shadow::PLUGIN_2),
    (Cow::Borrowed("grayscale"), &filter::grayscale::PLUGIN),
    (Cow::Borrowed("hue-rotate"), &filter::hue_rotate::PLUGIN_1),
    (Cow::Borrowed("hue-rotate"), &filter::hue_rotate::PLUGIN_2),
    (Cow::Borrowed("invert"), &filter::invert::PLUGIN),
    (Cow::Borrowed("saturate"), &filter::saturate::PLUGIN),
    (Cow::Borrowed("sepia"), &filter::sepia::PLUGIN),
    (Cow::Borrowed("filter"), &filter::filter_type::PLUGIN),
    (Cow::Borrowed("backdrop-blur"), &filter::backdrop_blur::PLUGIN_1),
    (Cow::Borrowed("backdrop-blur"), &filter::backdrop_blur::PLUGIN_2),
    (Cow::Borrowed("backdrop-brightness"), &filter::backdrop_brightness::PLUGIN),
    (Cow::Borrowed("backdrop-contrast"), &filter::backdrop_contrast::PLUGIN),
    (Cow::Borrowed("backdrop-grayscale"), &filter::backdrop_grayscale::PLUGIN),
    (Cow::Borrowed("backdrop-hue-rotate"), &filter::backdrop_hue_rotate::PLUGIN_1),
    (Cow::Borrowed("backdrop-hue-rotate"), &filter::backdrop_hue_rotate::PLUGIN_2),
    (Cow::Borrowed("backdrop-invert"), &filter::backdrop_invert::PLUGIN),
    (Cow::Borrowed("backdrop-saturate"), &filter::backdrop_saturate::PLUGIN),
    (Cow::Borrowed("backdrop-sepia"), &filter::backdrop_sepia::PLUGIN),
    (Cow::Borrowed("backdrop-filter"), &filter::backdrop_filter::PLUGIN),
    ...
    (Cow::Borrowed("line-clamp"), &typography::line_clamp::PLUGIN_1),
    (Cow::Borrowed("line-clamp"), &typography::line_clamp::PLUGIN_2),
