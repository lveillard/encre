...
pub(crate) const PLUGIN_X: (StaticPlugin, StaticPlugin) =
    plugin("px", SingleProp("padding-inline"));
...
pub(crate) const PLUGIN_START: (StaticPlugin, StaticPlugin) =
    plugin("ps", SingleProp("padding-inline-start"));
pub(crate) const PLUGIN_END: (StaticPlugin, StaticPlugin) =
    plugin("pe", SingleProp("padding-inline-end"));
